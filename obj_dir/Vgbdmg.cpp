...
void Vgbdmg::_sequent__TOP__3(Vgbdmg__Syms* __restrict vlSymsp) {
    ...
    // ALWAYSPOST at source/gbdmg.v:234
...
IData Vgbdmg::_change_request(Vgbdmg__Syms* __restrict vlSymsp) {
    ...
    VL_DEBUG_IF( if(__req && ((vlTOPp->v__DOT__trigger_env0 ^ vlTOPp->__Vchglast__TOP__v__DOT__trigger_env0))) VL_PRINTF("	CHANGE: source/gbdmg.v:215: v.trigger_env0\n"); );
    VL_DEBUG_IF( if(__req && ((vlTOPp->v__DOT__trigger_env1 ^ vlTOPp->__Vchglast__TOP__v__DOT__trigger_env1))) VL_PRINTF("	CHANGE: source/gbdmg.v:215: v.trigger_env1\n"); );
    VL_DEBUG_IF( if(__req && ((vlTOPp->v__DOT__trigger_env2 ^ vlTOPp->__Vchglast__TOP__v__DOT__trigger_env2))) VL_PRINTF("	CHANGE: source/gbdmg.v:215: v.trigger_env2\n"); );
    // Final
